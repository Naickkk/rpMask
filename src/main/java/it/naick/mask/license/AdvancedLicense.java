...
public class AdvancedLicense {
    ...
    public boolean register() {
        System.out.println("§6| §eConnessione al server delle licenze...");
        ValidationType vt = isValid();
        if (vt == ValidationType.VALID) {
            System.out.println("§2| §aLicenza verificata con successo");
            return true;
        } else {
            System.out.println("§4| §cLicenza non valida");
            System.out.println("§4| §cErrore: §7§o" + vt.toString());
